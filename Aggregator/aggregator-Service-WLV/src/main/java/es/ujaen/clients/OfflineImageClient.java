...
public class OfflineImageClient {
	...
	private String productionWSDL="http://sinai.ujaen.es/firstofflineimageretrieval/services/OfflineImageRetrieval?wsdl";
	private String developmentWSDL="http://sinai.ujaen.es/firstofflineimageretrieval/services/OfflineImageRetrieval?wsdl"; 
	private static Logger logger = Logger.getLogger(OfflineImageClient.class);
