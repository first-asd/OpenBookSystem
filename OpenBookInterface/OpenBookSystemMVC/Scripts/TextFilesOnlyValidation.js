...
(function ($) {
    $.validator.unobtrusive.adapters.add('txtonly', ['acceptedtypes'], function (options) {
        options.rules['txtonly'] = options.params;
        if (options.message) {
            options.messages['txtonly'] = options.message;
        }
    });

    $.validator.addMethod('txtonly', function (value, element, params) {
