...
###my $tagger_folder = "../Brill_tagger/RULE_BASED_TAGGER_V1.14/Bin_and_Data/";
...
# Changing encoding of the annotated sentences
...
#	    print STDERR "TEMP SENT IS $temp_sentence\nPRINT OS IS $print_original_sentence\n";
