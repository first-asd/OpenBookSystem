...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
	    ...
	    elsif($follows_rightmost_coordinator =~ /^(($any_kind_of_possPron|$any_kind_of_determiner|$any_kind_of_adj1|$any_kind_of_noun|\s)+)/){
		$np2 = $&;
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
	...
	elsif($precedes_rightmost_coordinator =~ /(($any_kind_of_number|$any_kind_of_possPron|$any_kind_of_determiner|\s)*)(($any_kind_of_noun|\s)*)($any_kind_of_noun)(\s*)$/){
...
#		print STDERR "SUBJ $subject\n";exit;
	    ...
	    @simpler_sentences[1] = "{CMN1-18b} ".$sentence2;
...
#		print STDERR "SUBJ $subject\n";exit;
	    ...
	    @simpler_sentences[1] = "{CMN1-19b} ".$sentence2;
...
#		print STDERR "HHHHHHHHHHHHH $prep ### $np1\n\t>>> $follows_rightmost_coordinator\n\tS1 $sentence1\n";
		...
		@simpler_sentences[1] = "{CMN1-21a} ".$sentence2.$final_punctuation;
		$simpler_sentences_ref = \@simpler_sentences;
		return($simpler_sentences_ref);
	    }
	}
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;
		...
		@simpler_sentences[1] = "{CMN1-22a} ".$sentence2.$final_punctuation;
		$simpler_sentences_ref = \@simpler_sentences;
		return($simpler_sentences_ref);
	    }
	} 
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";
		...
		@simpler_sentences[0] = "{CMN1-23a} ".$sentence1.$follows_coordination;
		@simpler_sentences[0] = "{CMN1-23b} ".$sentence2.$final_punctuation;
		$simpler_sentences_ref = \@simpler_sentences;
		return($simpler_sentences_ref);
	    }
	}
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;
		...
		@simpler_sentences[0] = "{CMN1-24a} ".$sentence1.$follows_coordination;
		@simpler_sentences[0] = "{CMN1-24b} ".$sentence2.$final_punctuation;
		$simpler_sentences_ref = \@simpler_sentences;
		return($simpler_sentences_ref);
	    }
	}
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
		...
		@simpler_sentences[1] = "{CMN1-94b} ".$sentence2;
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
		...
		@simpler_sentences[1] = "{CMN1-95b} ".$sentence2;
	    ...
	    $objects_of_verb = $POSTMATCH;
	    $this_verb = $&;
	    $np1 = $1.$2.$7.$11.$14.$16.$19.$24.$28.$29.$32.$36;	    
...
#		print STDERR "HHHHHHHHHHHHH $prep ### $np1\n\t>>> $follows_rightmost_coordinator\n\tS1 $sentence1\n";
		...
		@simpler_sentences[1] = "{CMN1-27a} ".$sentence2.$final_punctuation;
		$simpler_sentences_ref = \@simpler_sentences;
		return($simpler_sentences_ref);
	    }
	}
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;
		...
		@simpler_sentences[1] = "{CMN1-28a} ".$sentence2.$final_punctuation;
		$simpler_sentences_ref = \@simpler_sentences;
		return($simpler_sentences_ref);
	    }
	} 
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;
		...
		@simpler_sentences[1] = "{CMN1-29a} ".$sentence2.$final_punctuation;
		$simpler_sentences_ref = \@simpler_sentences;
		return($simpler_sentences_ref);
	    }
	}
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
		...
		@simpler_sentences[1] = "{CMN1-96b} ".$sentence2;
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
		...
		@simpler_sentences[1] = "{CMN1-139b} ".$sentence2;
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
		...
		@simpler_sentences[1] = "{CMN1-140b} ".$sentence2;
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;		
		...
		@simpler_sentences[1] = "{CMN1-141b} ".$sentence2;
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;
		...
		@simpler_sentences[0] = "{CMN1-97a} ".$sentence1.$final_punctuation;
		@simpler_sentences[1] = "{CMN1-97b} ".$sentence2;
...
# THE FOLLOWING CONDITION CAUSES RECURSION BETWEEN PATTERNS 87>>> AND 68>>> 
	    elsif($follows_rightmost_coordinator =~ /^AAAAAAAAAAAAAA(\s*)($any_kind_of_noun)(($any_kind_of_sentence_boundary|\s)*)$/){
		$np2 = $1.$2." ";
		$follows_coordination = $6.$POSTMATCH;
...
#		print STDERR "S1 $sentence1\nS2 $sentence2\n";exit;
		...
		@simpler_sentences[0] = "{CMN1-98a} ".$sentence1.$final_punctuation;
		@simpler_sentences[1] = "{CMN1-98b} ".$sentence2;
