...
#    print STDERR "SIMPLIFYING ######### $sentence\n";
    ...
    print STDERR "\t[CLQ]\nPRC $precedes_rightmost_coordinator\nFRC $follows_rightmost_coordinator\n";
...
################################### CLQ #######################################
    if($potential_coordinator =~ />(or|and)</){
...
# NOTE COORDINATED QUANTIFIERS ARE CONSIDERED COMBINATORY
    ...
    print STDERR "CLQ NO RULE MATCHED $sentence\n"; exit;
}
1;
