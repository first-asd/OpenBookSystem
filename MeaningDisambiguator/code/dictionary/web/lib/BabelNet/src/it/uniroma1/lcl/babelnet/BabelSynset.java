...
public class BabelSynset implements Iterable<BabelSense>
{
	 ...
	 *         {@link BabelSynset}.
	 */	
	public List<BabelImage> getImages() { return images; }
	 ...
	 *         {@link BabelSynset}.
	 */	
	public List<BabelCategory> getCategories() { return categories; }
	 ...
	 *         {@link BabelSynset}.
	 */
	public List<String> getWordNetOffsets() { return wnOffsets; }
	 ...
	 */
	public List<BabelSense> getSenses() { return senses; }
	 ...
	 */
	public List<BabelSense> getSenses(Language language, String lemma)
	{
		List<BabelSense> lemmaSenses = new ArrayList<BabelSense>();
		for (BabelSense sense : senses)
		{
			if (sense.getSimpleLemma().equalsIgnoreCase(lemma) && sense.getLanguage().equals(language))
